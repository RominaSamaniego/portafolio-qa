...
|  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- |
| PROYECTO: TALENTO LAB CONSULTORA |  |  |  |  |  |  | StoryTelling |
...
|  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- |
| ÉPICAS |  |  |  | FEATURES (Funcionalidades) |  |  |  |
|  |  |  |  |  |  |  |  |
...
| US-3 | Carga de cv | Como candidato, quiero adjuntar mi CV desde mi computadora para completar mi perfil laboral. | 1-El sistema debe permitir cargar archivos PDF y DOCX. 2-El tamaño máximo permitido debe ser de 5 MB. 3-El archivo debe cargarse correctamente sin generar errores. 4-El sistema debe mostrar confirmación de carga exitosa.                                       5-Si el archivo supera el tamaño permitido, el sistema debe mostrar un mensaje de error. 6-Si el formato del archivo no es válido, el sistema debe impedir la carga y notificar al usuario. |
| US-4 | Inicio de sesión | Como usuario, quiero iniciar sesión con mi correo electrónico y contraseña para acceder a mi perfil y funcionalidades de la plataforma. | 1- El sistema debe permitir ingresar con credenciales válidas. 2-El correo electrónico debe validar el formato correcto antes de iniciar sesión. 3-Si las credenciales son incorrectas, el sistema debe mostrar un mensaje de error. 4-El inicio de sesión debe completarse en menos de 2 segundos. 5-Después de iniciar sesión correctamente, el usuario debe ser redirigido al panel principal.     6-El campo de contraseña debe ocultar los caracteres ingresados. 7-El sistema no debe permitir el acceso si algún campo está vacío. |
| US-5 | Postulación a vacante | Como candidato, quiero postularme a una vacante laboral para participar en procesos de selección. | 1-El usuario debe haber iniciado sesión para postularse a una vacante. 2-El sistema debe permitir seleccionar una oferta laboral disponible. 3-Al hacer clic en “Postularme”, la solicitud debe enviarse correctamente. 4-La postulación debe registrarse en la base de datos sin errores.                                                                                                                                                                       5-El sistema debe permitir que únicamente los usuarios autenticados puedan postularse a una vacante laboral. 6-El sistema debe mostrar al candidato las vacantes disponibles para postulación. 7-Cuando el candidato seleccione una vacante y haga clic en el botón “Postularme”, el sistema debe registrar correctamente la postulación. 8-El sistema debe mostrar un mensaje de confirmación indicando que la postulación fue realizada exitosamente. 9-El sistema debe almacenar la información de la postulación en la base de datos sin errores ni duplicados. 10-El candidato no debe poder postularse más de una vez a la misma vacante. 11-El sistema debe asociar la postulación al perfil del candidato autenticado. 12-Si ocurre un error durante la postulación, el sistema debe mostrar un mensaje indicando que la operación no pudo completarse. 13-El candidato debe poder visualizar el estado de su postulación después de registrarse. |
| US-6 | Formulario de contacto | Como usuario, quiero enviar consultas mediante el formulario de contacto para comunicarme con el equipo de soporte. | 1-Todos los campos obligatorios deben validarse antes del envío. 2-El correo electrónico debe tener un formato válido. 3-El sistema debe enviar correctamente el formulario al completar los datos. 4-Después del envío exitoso, debe mostrarse un mensaje de confirmación. 5-Si ocurre un error, el sistema debe mostrar un mensaje informativo al usuario indicando que la solicitud no pudo procesarse.                                                                                                                   6-El sistema no debe permitir el envío del formulario con campos vacíos obligatorios. 7-El usuario debe poder ingresar mensajes dentro del límite de caracteres permitido por el sistema. 8-El sistema debe proteger el formulario contra el envío de datos inválidos o caracteres no permitidos. |
...
| Fecha: | 2026-03-12 |  |  | contraseña vadilo | RLJ#2923 |
...
| Prioridad: | Alta | (Alta, Media, Baja) |  | Nombre | Romina |
| Tipo de Test: |  | (Funcional, No funcional...) |  | Email válido | asdQ@gmail.com |
| Fecha: | 2026-03-12 |  |  | contraseña válido | RLJ#2923 |
|  |  |  |  | CV_ válido | formato pdf |
| ID | Título | Precondiciones | Pasos |  |  |
...
| Prioridad: | Alta | (Alta, Media, Baja) |  | Nombre | Romina |
| Tipo de Test: |  | (Funcional, No funcional...) |  | Email Válido | asdQ@gmail.com |
| Fecha: | 2026-03-12 |  |  | contraseña vádila | RLJ#2923 |
|  |  |  |  | CV_ válido | formato pdf |
| ID | Título | Precondiciones | Pasos |  |  |
...
| Fecha: | 2026-03-12 |  |  | contraseña invádilo | 111 |
|  |  |  |  | CV_ válido | formato pdf |
| ID | Título | Precondiciones | Pasos |  |  |
...
| Fecha: | 2026-03-12 |  |  | contraseña válido | vacio |
...
| Prioridad: | Alta | (Alta, Media, Baja) |  | Nombre | Romina |
| Tipo de Test: | manual | (Funcional, No funcional...) |  | Email válido | asdQ@gmail.com |
| Fecha: | 2026-03-12 |  |  | contraseña | RLJ#2923 |
| ID | Título | Precondiciones | Pasos | Cv formato pfd | formato pdf |
