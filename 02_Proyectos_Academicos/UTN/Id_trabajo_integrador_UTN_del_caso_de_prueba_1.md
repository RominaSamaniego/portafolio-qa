...
| 3 hacer click en LAPTOPS | 3 seleccionar producto con un valor de 0>=100 |
| 4.ver descripción del producto | 4. visualizar texto color negro |
| 5. Presionar el botón “add to cart” | 4. Debería cargar la página nuevamente con formulario a rellenar referido a la compra a realizar. |
| Post condiciones | DELETED cookies |
| Versión del documento | Vs00 |
